...
import { gemini_model_names } from "../constants/aimodel.constant";
import { IChatMessage, IMessage } from "../schema/chat.model";
...
class AgentService {
  ...
  async processRequest(
    ...
    try {
      ...
      const messageHistory = this.buildMessageHistory(chatData?.messages);
